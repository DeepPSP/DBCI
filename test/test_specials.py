...
# fmt: off
# from https://github.com/cran/ExactCIdiff/blob/master/R/BinomCI.r
r("""
...
wang_binomial_ci_r<-function(x, n1, y, n2, conf.level = 0.95, CItype = "Two.sided", precision = 0.00001,grid.one=30,grid.two=20)
{
